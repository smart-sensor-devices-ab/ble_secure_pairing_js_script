...
function logSubmit(event) {
  ...
  if (connectionOption == 1) {
    my_dongle.at_central().then(function (d) {
      console.log(d);
      div.innerHTML += d + '<br>';
      my_dongle.at_gapiocap(2).then(function (d) {
        console.log(d);
        div.innerHTML += d + '<br>';
        my_dongle.at_gapconnect(macaddress).then(function (d) {
          setTimeout(function () {
            my_dongle.at_enterpasskey(passkey).then(function (d) {
              console.log(d);
              div.innerHTML += d + '<br>';
            });
          }, 2000);
          console.log(d);
          div.innerHTML += d + '<br>';
          my_dongle.at_seclvl().then(function (d) {
            console.log(d);
            div.innerHTML += d + '<br>';
          });
        });
  ...
  if (connectionOption == 2) {
    my_dongle.at_central().then(function () {
      my_dongle.at_gapiocap(1).then(function () {
        my_dongle.at_numcompa(0).then(function () {
          my_dongle.at_gapconnect(macaddress).then(function (d) {
            setTimeout(function () {
              my_dongle.at_numcompa().then(function (d) {
                console.log(d);
                div.innerHTML += d + '<br>';
              });
            }, 2000);
...
//# sourceMappingURL=/bleuio-security.e31bb0bc.js.map